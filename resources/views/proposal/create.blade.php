                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nomorsurat" name="noproposal" class="form-control" id="validationCustom02" placeholder="0307101082021">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul" id="exampleInputHal1" class="form-control" placeholder="FESTIVAL MULTIMEDIA DAN TEKNIK KOMPUTER">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jenis" id="">
                                            ...
                                            <option value="Proposal Lomba">Proposal Lomba</option>
                                            <option value="Proposal Sponsor">Proposal Sponsor</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <input type="hidden" name="users_id" value="1">
