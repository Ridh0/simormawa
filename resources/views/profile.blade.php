							...
							<div class="card-body border-top pro-wrk-edit collapse " id="pro-wrk-edit-2">
								<form>
									...
									<div class="form-group row align-items-center">
										<label class="col-sm-3 col-form-label font-weight-bolder">Jobs</label>
										<div class="col-sm-9">
											<div class="form-check form-check d-inline-block me-2">
												<input type="checkbox" class="form-check-input" id="pro-wrk-chk-1" checked>
												<label class="form-check-label" for="pro-wrk-chk-1">C#</label>
											</div>
											<div class="form-check form-check d-inline-block me-2">
												<input type="checkbox" class="form-check-input" id="pro-wrk-chk-2" checked>
												<label class="form-check-label" for="pro-wrk-chk-2">Javascript</label>
											</div>
											<div class="form-check form-check d-inline-block me-2">
												<input type="checkbox" class="form-check-input" id="pro-wrk-chk-3" checked>
												<label class="form-check-label" for="pro-wrk-chk-3">Scss</label>
											</div>
											<div class="form-check form-check d-inline-block me-2">
												<input type="checkbox" class="form-check-input" id="pro-wrk-chk-4">
												<label class="form-check-label" for="pro-wrk-chk-4">Html</label>
											</div>
										</div>
									</div>
									<div class="form-group row align-items-center mt-2">
							...
							<div class="col-md-6">
								<div class="card user-card user-card-1">
									...
									<div class="card-body pt-0">
										<div class="user-about-block text-center position-relative">
											<div class="row align-items-end">
												<div class="col text-start pb-3"><a href="#!"><i class="icon feather icon-star text-muted f-20"></i></a></div>
								...
								<div class="card user-card user-card-1">
									...
									<div class="card-body pt-0">
										<div class="user-about-block text-center">
											<div class="row align-items-end">
												<div class="col text-start pb-3"><a href="#!"><i class="icon feather icon-star-on text-c-yellow f-20"></i></a></div>
												<div class="col">
													<div class="position-relative d-inline-block">
			...
			<div class="col-md-4 order-md-1">
				<div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						...
						<span class="badge badge-light-primary float-end">100+</span>
					</div>
					<div class="card-body">
